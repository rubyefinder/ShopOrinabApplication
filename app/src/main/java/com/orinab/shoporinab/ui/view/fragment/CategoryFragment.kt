...
import com.orinab.shoporinab.databinding.FragmentCategoryBinding
...
import com.orinab.shoporinab.utils.build_config.BuildConfig
import com.orinab.shoporinab.utils.build_config.BuildConfig.Companion.CONST_ALL_PRODUCT
...
class CategoryFragment : Fragment() {
    ...
    private fun initOnClickListener(any: Any) {
        ...
        navController.navigate(
            R.id.action_mainFragment_to_detailSingleCobinetFragment,
            initBundle(requireContext(),gson, BuildConfig.BUNDLE_DETAIL_SINGLE, pro)
        )
    }

    private fun initRequestCabinetKitchen() {
        initShowLoading()
        dashboardViewModel.initCabinetKitchen(CONST_ALL_PRODUCT).observe(
            viewLifecycleOwner,
